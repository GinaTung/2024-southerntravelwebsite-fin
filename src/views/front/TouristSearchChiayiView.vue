<template>
  <div class="card mb-4 card-att" v-for="productsItem in searchChiayi" :key="productsItem.id">
    <div class="row g-0">
      <div class="col-md-4">
    ...
    <ul class="pagination justify-content-center">
      <li class="page-item" :class="{ disabled: !currentPage || currentPage === 1 }">
        <a
          ...
          href=""
          @click.prevent="searchProducts(currentPage - 1)"
          >上一頁</a
        >
      </li>
...
export default {
  ...
  methods: {
    ...
    searchProducts(currentPage = 1) {
      this.axios
        .get(`${api_url2}/products?category=嘉義&_limit=${this.limitPage}&_page=${currentPage}`)
        .then((res) => {
          // console.log(res)
