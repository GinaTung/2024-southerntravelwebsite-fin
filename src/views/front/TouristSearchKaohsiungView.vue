<template>
  <div class="card mb-4 card-att" v-for="productsItem in searchKaohsiung" :key="productsItem.id">
    <div class="row g-0">
      <div class="col-md-4">
...
export default {
  ...
  methods: {
    ...
    searchProducts(currentPage=1) {
      this.axios
        .get(`${api_url2}/products?category=高雄&_limit=${this.limitPage}&_page=${currentPage}`)
        .then((res) => {
          // console.log(res)
          ...
          this.searchKaohsiung = [] // 清空已啟用的產品列表
